...
const baileys_version_json_1 = require("../Defaults/neodev-baileys-version.json");
...
const fetchLatestBaileysVersion = async (options = {}) => {
    const URL = 'https://raw.githubusercontent.com/Neodev-Z3roDay/baileys/master/src/Defaults/baileys-version.json';
    try {
